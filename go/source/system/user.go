...
func (u *user) Initialize() error {
	entities := []system.SysUser{
		...
		{UUID: uuid.NewV4(), Username: "user", Password: utils.MD5V([]byte(global.GVA_CONFIG.Login.InitPassword)), NickName: "User", HeaderImg: "https://pica.zhimg.com/v2-2bb8251e0eb4bf14612bf02939e6ced0_1440w.jpg", AuthorityId: "886", Phone: "17611111113", Email: "933333333@qq.com"},
	}
