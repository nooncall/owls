...
func (m *menu) Initialize(initData *system.InitDBData) error {
	entities := []system.SysBaseMenu{
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 22}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "http://owls.nooncall.cn:8778", Name: "http://owls.nooncall.cn:8778/docs", Component: "/", Sort: 0, Meta: system.Meta{Title: "官方文档", Icon: "home-filled"}},
